...
//    cout << "Facts: " << possibleID << " ," << possibleParameter << endl;
//	//Add to Fact Set, then sort
//	factStringsSet.insert(firstParameter);
...
//    cout << "CaptureVector Size (Fact): " << captureVector.size() << endl;
    
    //Add to Relation
    Tuple newTuple(captureVector);
//    cout << "Tuple created" << endl;
//    cout << "Tuple Size(Fact): " << newTuple.size() << endl;
...
//    newRelation.printRelations();
	...
	captureVector.erase(captureVector.begin(),captureVector.end());
//    cout << "IS it even in Facts?" << endl;
    
//    cout << "Fact: " << possibleID << " Size: " << myDatabase.databaseMap[possibleID].getSize() << endl;
}
...
//cout << "QueryTest1" << endl;
    set<Tuple> answerSet = myDatabase.queryAnswer(ID,newPList);
    
    
//    cout << "Query being parsed: " << ansRel.getRelationID() << "(" << newPList[0].getParameterValue() << "," << newPList[1].getParameterValue() << ")" << endl;

//cout << "It's probably here" << endl;
    //Print Query
//    ansRel.printRelation(answerSet, newPList);
}
